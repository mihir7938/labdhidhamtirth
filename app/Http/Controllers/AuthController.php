        ...
        try {
            ...
            if ($is_auth) {
                ...
                if ($request->ajax()) {
                    ...
                    if($search_values && count($search_values)> 0 && array_key_exists('checkin_date', $search_values) && array_key_exists('days', $search_values) && array_key_exists('room_types', $search_values)
                    ) {
