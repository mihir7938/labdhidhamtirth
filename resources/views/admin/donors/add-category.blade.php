...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <form method="POST" action="{{route('admin.donors.addcategory.save')}}" class="form" id="add-donor-category-form" enctype="multipart/form-data">
            <div class="card-body">
                @csrf
                @if (count($errors) > 0)
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#add-donor-category-form').validate({
            rules:{
                title:{
                    required: true
                },
