        ...
        <form method="POST" action="{{route('admin.events.update.save')}}" class="form" id="edit-event-form" enctype="multipart/form-data">
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="title" name="title" placeholder="Enter Your Title" value="{{$event->title}}">
                </div>
                <div class="form-group">
                    ...
                    @if($event->image)
                        <img src="{{asset('assets/'.$event->image)}}" width="100px" class="mt-4 d-block" /> 
                    @endif
                </div>
            </div>
